...
//   let resultDataFinish = await response.json()
//   console.log(resultDataFinish);
// }
// getData()
...
// ^ Filter by Area
// async function getData(){
//   let response = await fetch("https://www.themealdb.com/api/json/v1/1/filter.php?a=Canadian");
//   let resultDataFinish = await response.json()
//   console.log(resultDataFinish);
// }
// getData()
...
//& Function Add Data In Inner HTML Inter The Home Section:===========================
      ...
      async function checkIdAllHome(e){
        ...
        DisplayDescriptionHome(responseElementById)
      ...
      function DisplayDescriptionHome(element){
        let cartona = `
          <div class="col-md-4">
          ...
          <div class="col-md-8">
            <div class="textItemDetails text-white p-4 pt-0">
              ...
              <div class="span">
                ...
                <span class="p-1 rounded-2 d-inline-block m-2 bg-primary-subtle text-black">${element.strIngredient9}</span>
              </div>
              <h2 class="my-2">Tags :</h2>
              <span class="p-1 rounded-2 d-inline-block m-2 bg-danger-subtle text-danger-emphasis" >${element.strTags}</span>
...
function AddSearch(){
  ...
  document.getElementById("SearchInputLitter").addEventListener("input" , function(){
    ...
    // console.log(SearchInputLitter.value);
  })
  ...
  async function checkIdAllSearch(e){
    ...
    document.getElementById("inputSearch").innerHTML = "";
    DisplayDescriptionAll(responseElementById)
  ...
  // * Function Display Description Meals All Page 
  function DisplayDescriptionAll(element){
    let cartona = `
      <div class="col-md-4">
        <button class="btn btn-info position-fixed top-0 end-0 m-4" onclick="location.reload()">Home Page</button>
        <div class="imageItemDetails">
...
function addIngredients(){
  document.getElementById("rowData").innerHTML = '<h1 class="text-center text-white">add-Ingredients</h1>';
}
//& =========================================================================================
  ...
  //& ===========Validation Of Form Input===========================================
    ...
    phoneInput.addEventListener("input" , function(){
      if(validationPhoneNumber ()){
        ...
        document.getElementById("phoneText").innerHTML = "Not Valid Phone"
        flagPhone = false;
      }
      checkValidFinish()
    })
...
//& =========================== All Meals  First Page ===========================================
// // ^ Api get Meals All Page  :
// async function getData(){
//   let api = await fetch("https://www.themealdb.com/api/json/v1/1/filter.php?a=Canadian");
//   let result = await api.json();
...
// }
// getData()
// // ^ Function Display Meals All Page   :
...
//   let elementIndex = mealsName[index];
//   console.log(elementIndex);
//   DisplayDescription(elementIndex)
// }


// // ^ Function Display Description Element Index Of Array :
// function DisplayDescription(element){
//   formInput.innerHTML = "";
//   let cartona = `
//     <div class="col-md-4">
//       <div class="imageItemDetails">
//         <img src="image/14.jpg"  class="w-100 rounded-4 overflow-hidden" alt="image">
//         <h2 class="mt-3 text-white">Pizza</h2>
//       </div>
//     </div>
//     <div class="col-md-8">
//       <div class="textItemDetails text-white p-4 pt-0">
//         <h2 class="fw-bold mb-2">Instructions</h2>
//         <p>${element.strInstructions}.</p>
//         <h2 class="fw-bold mb-2">Area : ${element}</h2>
//         <h2 class="fw-bold mb-2">Category : ${element}</h2>
//         <h3 class="fw-bold mb-2">Recipes :</h3>
//         <div class="span">
//           <span class="p-1 rounded-2 d-inline-block m-2 bg-primary-subtle text-black">${element.strMeasure1}</span>
//           <span class="p-1 rounded-2 d-inline-block m-2 bg-primary-subtle text-black">${element.strMeasure2}</span>
//           <span class="p-1 rounded-2 d-inline-block m-2 bg-primary-subtle text-black">${element.strMeasure3}</span>
//           <span class="p-1 rounded-2 d-inline-block m-2 bg-primary-subtle text-black">${element.strMeasure4}</span>
//           <span class="p-1 rounded-2 d-inline-block m-2 bg-primary-subtle text-black">${element.strMeasure5}</span>
//           <span class="p-1 rounded-2 d-inline-block m-2 bg-primary-subtle text-black">${element.strMeasure6}</span>
//           <span class="p-1 rounded-2 d-inline-block m-2 bg-primary-subtle text-black">${element.strMeasure7}</span>
//           <span class="p-1 rounded-2 d-inline-block m-2 bg-primary-subtle text-black">${element.strMeasure8}</span>
//           <span class="p-1 rounded-2 d-inline-block m-2 bg-primary-subtle text-black">${element.strMeasure9}</span>
//         </div>

//         <h2 class="my-2">Tags :</h2>
//         <span class="p-1 rounded-2 d-inline-block m-2 bg-danger-subtle text-danger-emphasis" >${element}</span>
//         <div class="btnDiv my-3">
//         <button class="btn btn-success "><a class="text-white" href="${element.strSource}">Source</a></button>
//         <button class="btn btn-danger "><a class="text-white" href="${element.strYoutube}">YouTube</a></button>
//         </div>
...
//     </div>
//     `
//     rowDataSearch.innerHTML = cartona;
//   }
